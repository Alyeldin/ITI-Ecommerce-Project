const fetchAuthors = async () => {
  ...
  const url =
    "https://tmlgzmvphyqiygezzgmc.supabase.co/rest/v1/authors?select=*";
  const anonKey =
            ...
            <div class="col">
              <div class="card h-100 border-0 shadow-sm text-center p-4">
                ...
                <div class="card-body p-0 d-flex flex-column">
                  ...
                  <div class="mt-auto">
                    <a href="/pages/products.html?id=${author.id}" class="btn btn-brand w-100 py-2 rounded-pill">View Their Books</a>
                  </div>
                </div>
